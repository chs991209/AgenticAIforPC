...
from src.agent_as_a_tool_daily_pc.agent_team_action_extractor import extract_final_answer
import httpx
import os
import time
    ...
    if len(decomposed_prompt):
        ...
        for config in team_configs:
            ...
            try:
                ...
                print(f"[Agent Chat had maintained] for {end_time - start_time:.2f} seconds")
                # CONTENTGENERATIONDONE 있는지 확인
                ...
                has_actions_done = any(
                    "CONTENTGENERATIONDONE" in _msg_text(msg)
                    for msg in messages
                )
