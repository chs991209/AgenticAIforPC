...
#     Once you receive the validated URLs, output them as a strict JSON object: {"youtube_urls": ["url1", "url2"]}.
...
DO NOT, under any circumstances on this turn:
  ...
  - DO NOT output any object like `{"youtube_urls": ...}`.
...
DO, in this exact order:
  1. Output exactly one JSON object on its own line:
     ...
     If the validator returned an empty array, output: {"youtube_urls": []}
